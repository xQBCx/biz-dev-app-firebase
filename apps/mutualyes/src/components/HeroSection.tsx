    ...
    <section className="min-h-screen flex items-center justify-center px-4 pt-32">
      <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight drop-shadow-lg">
          Verified Consent,
          <br />
          <span className="text-primary drop-shadow-lg">Clear Communication</span>
        </h1>
        
        <p className="text-lg md:text-xl text-white font-semibold max-w-2xl mx-auto drop-shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-12">
          {[
            ...
            <div 
              key={index}
              className="bg-card/30 backdrop-blur-md p-6 rounded-2xl shadow-md hover:shadow-lg transition-shadow border border-border/20"
            >

...
const HowItWorksSection = () => {
  ...
  return <section id="how-it-works" className="py-20 px-4 bg-card/20 backdrop-blur-sm">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          animationDelay: `${index * 0.1}s`
              ...
              <div className="bg-card/30 backdrop-blur-md p-6 rounded-2xl shadow-md hover:shadow-xl transition-all h-full border border-border hover:border-primary">
        ...
        <div className="mt-16 p-8 bg-primary/10 backdrop-blur-sm rounded-2xl border border-primary/30">
          <h3 className="text-2xl font-extrabold text-center mb-4 text-white">
            Why Mutual Yes?
          </h3>
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div>
              <h4 className="font-bold text-primary mb-2">Protection for Everyone</h4>
            ...
            <div>
              <h4 className="font-bold text-primary mb-2">Legal Peace of Mind</h4>
              <p className="text-white text-sm font-medium">
            ...
            <div>
              <h4 className="font-bold text-primary mb-2">Prevents Misunderstandings</h4>
              <p className="text-white text-sm font-medium">
            ...
            <div>
              <h4 className="font-bold text-primary mb-2">Complete Privacy</h4>
              <p className="text-white text-sm font-medium">

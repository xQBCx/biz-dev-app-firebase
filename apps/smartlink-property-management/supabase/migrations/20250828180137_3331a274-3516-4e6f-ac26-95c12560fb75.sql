...
-- Add sample Standard Operating Procedures using existing allowed departments
INSERT INTO sops (title, department, sop_url) VALUES
  ('Guest Check-in Procedures', 'frontdesk', 'https://docs.smartlinkmgt.com/sops/checkin-procedures'),
  ('Room Cleaning Standards', 'housekeeping', 'https://docs.smartlinkmgt.com/sops/room-cleaning'),
  ('Emergency Response Protocol', 'general', 'https://docs.smartlinkmgt.com/sops/emergency-response'),
  ('Revenue Management Guidelines', 'general', 'https://docs.smartlinkmgt.com/sops/revenue-management'),
  ('Maintenance Request Handling', 'maintenance', 'https://docs.smartlinkmgt.com/sops/maintenance-requests'),
  ('Group Sales Process', 'general', 'https://docs.smartlinkmgt.com/sops/group-sales'),
  ('Guest Complaint Resolution', 'frontdesk', 'https://docs.smartlinkmgt.com/sops/complaint-resolution'),
  ('Food Safety Standards', 'general', 'https://docs.smartlinkmgt.com/sops/food-safety'),
  ('New Employee Onboarding', 'general', 'https://docs.smartlinkmgt.com/sops/employee-onboarding'),
  ('Property Inspection Checklist', 'general', 'https://docs.smartlinkmgt.com/sops/property-inspection');

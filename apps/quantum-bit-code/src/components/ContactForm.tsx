        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-16 text-center">
            <h2 className="mb-4 text-4xl font-bold text-foreground md:text-5xl">
              <DecryptedText text="Request Investor Access" animateOn="view" speed={35} maxIterations={12} />
            </h2>
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              <DecryptedText 
                text="Qualified institutional and accredited investors can request access to our Virtual Data Room for detailed documentation and investment materials." 
                animateOn="view" 
                speed={15} 
                maxIterations={6} 
              />

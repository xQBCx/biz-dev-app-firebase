...
const ROUTE_KEYWORDS: Record<string, { path: string; title: string; icon: React.ReactNode; category: string }> = {
  ...
  'execution mode': { path: '/trading-command/execute', title: 'Trading Execution', icon: <DollarSign className="h-4 w-4" />, category: 'lifecycle' },
  'execute trade': { path: '/trading-command/execute', title: 'Trading Execution', icon: <DollarSign className="h-4 w-4" />, category: 'lifecycle' },
  'start trading': { path: '/trading-command/execute', title: 'Trading Execution', icon: <DollarSign className="h-4 w-4" />, category: 'lifecycle' },
  'orb levels': { path: '/trading-command/execute', title: 'Trading Execution', icon: <DollarSign className="h-4 w-4" />, category: 'lifecycle' },
  'preflight': { path: '/trading-command/execute', title: 'Trading Execution', icon: <DollarSign className="h-4 w-4" />, category: 'lifecycle' },
  'circuit breaker': { path: '/trading-command/execute', title: 'Trading Execution', icon: <DollarSign className="h-4 w-4" />, category: 'lifecycle' },
  'discipline over dopamine': { path: '/trading-command/execute', title: 'Trading Execution', icon: <DollarSign className="h-4 w-4" />, category: 'lifecycle' },

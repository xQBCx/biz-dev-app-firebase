...
const navGroups: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/xevents", label: "xEVENTSx", icon: CalendarDays, module: 'deal_rooms' },
      { path: "/initiatives", label: "Initiative Architect", icon: Rocket, module: 'deal_rooms' },
      ...
      { path: "/partners", label: "Partner Management", icon: Handshake, module: 'deal_rooms' },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/proposals", label: "Proposal Generator", icon: FileText, module: 'deal_rooms' },

...
const navGroups: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/system-intelligence", label: "System Intelligence", icon: Brain, module: 'xodiak' },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/growth-instruments", label: "Growth Instruments", icon: TrendingUp, module: 'core' },
      { path: "/creator-studio", label: "Creator Studio", icon: Palette, module: 'core' },
      { path: "/talent-network", label: "Talent Network", icon: Target, module: 'crm' },
      { path: "/biz-dev-news", label: "BizDev.news", icon: Newspaper, module: 'core' },
      ...
      { path: "/xevents", label: "xEVENTSx", icon: CalendarDays, module: 'xevents' },
      { path: "/initiatives", label: "Initiative Architect", icon: Rocket, module: 'initiatives' },
      ...
      { path: "/partners", label: "Partner Management", icon: Handshake, module: 'partner_management' },
  ...
  },
  {
    ...
    items: [
      { path: "/opportunity-discovery", label: "Opportunity Discovery", icon: Search, module: 'crm' },
      { path: "/proposals", label: "Proposal Generator", icon: FileText, module: 'proposal_generator' },
      { path: "/xstay", label: "xSTAYx Properties", icon: Home, module: 'core' },
...
export function AppSidebar() {
  ...
  const { hasRole, ready: rolesReady } = useEffectiveUserRole();
  const { brandName } = useWhiteLabel();
  const { hasPermission, isAdmin, isLoading: permissionsLoading } = useEffectivePermissions();
  const navigate = useNavigate();
  // Use effective role check - will return false for admin if impersonating a non-admin
